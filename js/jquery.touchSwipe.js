!function(e) {
    ...
    function n(n, D) {
        ...
        function N(n, u, s) {
            var g;
            if (s == c) {
                if (me.trigger("swipeStatus", [u, de || null, he || 0, ge || 0, Se, Oe, fe]), D.swipeStatus && !1 === (g = D.swipeStatus.call(me, n, u, de || null, he || 0, ge || 0, Se, Oe, fe)))
                    return !1;
                if (u == E && F()) {
                    if (clearTimeout(ke), clearTimeout(Ae), me.trigger("swipe", [de, he, ge, Se, Oe, fe]), D.swipe && !1 === (g = D.swipe.call(me, n, de, he, ge, Se, Oe, fe)))
                        return !1;
                    switch (de) {
                    case t:
            ...
            if (s == p) {
                if (me.trigger("pinchStatus", [u, ye || null, be || 0, ge || 0, Se, Te, Oe]), D.pinchStatus && !1 === (g = D.pinchStatus.call(me, n, u, ye || null, be || 0, ge || 0, Se, Te, Oe)))
                    return !1;
                if (u == E && Q())
                    switch (ye) {
                    case o:
