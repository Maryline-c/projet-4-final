!function(e, t) {
    ...
    h.fn = h.prototype = {
        ...
        for ("boolean" == typeof s && (l = s, s = arguments[a] || {}, a++), "object" == typeof s || h.isFunction(s) || (s = {}), a === u && (s = this, a--); u > a; a++)
            if (null != (e = arguments[a]))
                for (t in e)
                    n = s[t], s !== (r = e[t]) && (l && r && (h.isPlainObject(r) || (i = h.isArray(r))) ? (i ? (i = !1, o = n && h.isArray(n) ? n : []) : o = n && h.isPlainObject(n) ? n : {}, s[t] = h.extend(l, o, r)) : void 0 !== r && (s[t] = r));
        return s
    }, h.extend({
        ...
        isPlainObject: function(e) {
            if ("object" !== h.type(e) || e.nodeType || h.isWindow(e))
                return !1;
            try {
                if (e.constructor && !l.call(e.constructor.prototype, "isPrototypeOf"))
                    return !1
            } catch (e) {
                return !1
            }
    ...
    var x = function(e) {
        ...
        function ne(e, t, r, i) {
            var o,
                ...
                b,
                w;
            if ((t ? t.ownerDocument || t : x) !== f && c(t), r = r || [], !e || "string" != typeof e)
                return r;
            if (1 !== (u = (t = t || f).nodeType) && 9 !== u)
                return [];
            if (d && !i) {
                if (o = J.exec(e))
                    if (a = o[1]) {
                ...
                if (n.qsa && (!h || !h.test(e))) {
                    if (m = g = y, b = t, w = 9 === u && e, 1 === u && "object" !== t.nodeName.toLowerCase()) {
                        for (p = de(e), (g = t.getAttribute("id")) ? m = g.replace(Z, "\\$&") : t.setAttribute("id", m), m = "[id='" + m + "'] ", l = p.length; l--;)
                            p[l] = m + he(p[l]);
        ...
        for (t in n = ne.support = {}, o = ne.isXML = function(e) {
            ...
            return i !== f && 9 === i.nodeType && i.documentElement ? (f = i, p = i.documentElement, d = !o(i), s && s !== s.top && (s.addEventListener ? s.addEventListener("unload", function() {
                ...
                var n,
                    ...
                    c = [t];
                if (!o || !s)
                    return e === i ? -1 : t === i ? 1 : o ? -1 : s ? 1 : u ? O.call(u, e) - O.call(u, t) : 0;
                if (o === s)
                    return ae(e, t);
            ...
            if ((e.ownerDocument || e) !== f && c(e), t = t.replace(X, "='$1']"), !(!n.matchesSelector || !d || g && g.test(t) || h && h.test(t)))
                try {
                    var r = m.call(e, t);
            ...
            filter: {
                ...
                CHILD: function(e, t, n, r, i) {
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (m) {
                            ...
                            } else if (x && (l = (t[y] || (t[y] = {}))[e]) && l[0] === b)
                                p = l[1];
                            else
                                for (; (f = ++d && f && f[g] || (p = d = 0) || h.pop()) && ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++p || (x && ((f[y] || (f[y] = {}))[e] = [b, p]), f !== t));)
                                    ;
                ...
                PSEUDO: function(e, t) {
                    var n,
                        i = r.pseudos[e] || r.setFilters[e.toLowerCase()] || ne.error("unsupported pseudo: " + e);
            ...
            pseudos: {
                ...
                lang: ie(function(e) {
                    return U.test(e || "") || ne.error("unsupported lang: " + e), e = e.replace(ee, te).toLowerCase(), function(t) {
                        var n;
                        do {
        ...
        function de(e, t) {
            ...
            for (a = e, u = [], l = r.preFilter; a;) {
                for (s in (!n || (i = I.exec(a))) && (i && (a = a.slice(i[0].length) || a), u.push(o = [])), n = !1, (i = _.exec(a)) && (n = i.shift(), o.push({
                    ...
                    !(i = V[s].exec(a)) || l[s] && !(i = l[s](i)) || (n = i.shift(), o.push({
                        value: n,
                        type: s,
                        matches: i
                    }), a = a.slice(n.length));
            ...
            return r && !r[y] && (r = ye(r)), i && !i[y] && (i = ye(i, o)), ie(function(o, s, a, u) {
                ...
                if (o) {
                    if (i || e) {
                        ...
                        for (c = v.length; c--;)
                            (f = v[c]) && (l = i ? O.call(o, f) : p[c]) > -1 && (o[l] = !(s[l] = f))
                    }
                } else
                    v = ve(v === s ? v.splice(h, v.length) : v), i ? i(null, s, v, u) : q.apply(s, v)
            })
        }
        function xe(e) {
        ...
        when: function(e) {
            ...
            if (a > 1)
                for (t = new Array(a), n = new Array(a), i = new Array(a); a > o; o++)
                    s[o] && h.isFunction(s[o].promise) ? s[o].promise().done(c(o, i, s)).fail(l.reject).progress(c(o, n, t)) : --u;
    ...
    h.acceptData = function(e) {
        ...
        set: function(e, t, n) {
            ...
            if ("string" == typeof t)
                o[t] = n;
            else if (h.isEmptyObject(o))
                h.extend(this.cache[i], t);
            else
                for (r in t)
                    o[r] = t[r];
            return o
        ...
        data: function(e, t) {
            ...
            if (void 0 === e) {
                if (this.length && (i = P.get(o), 1 === o.nodeType && !F.get(o, "hasDataAttrs"))) {
                    for (n = s.length; n--;)
                        0 === (r = s[n].name).indexOf("data-") && (r = h.camelCase(r.slice(5)), W(o, r, i[r]));
            ...
            return "object" == typeof e ? this.each(function() {
                ...
                var n,
                    r = h.camelCase(e);
                if (o && void 0 === t) {
                    if (void 0 !== (n = P.get(o, e)))
                        return n;
                    if (void 0 !== (n = P.get(o, r)))
                        return n;
                    if (void 0 !== (n = W(o, r, void 0)))
                        return n
                } else
                    this.each(function() {
                        var n = P.get(this, r);
    ...
    h.event = {
        ...
        add: function(e, t, n, r, i) {
            ...
            if (v)
                ...
                }), l = (t = (t || "").match(A) || [""]).length; l--;)
                    d = m = (a = Y.exec(t[l]) || [])[1], g = (a[2] || "").split(".").sort(), d && (f = h.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = h.event.special[d] || {}, c = h.extend({
                        type: d,
                        origType: m,
                        data: r,
                        handler: n,
            ...
            if (v && (u = v.events)) {
                for (l = (t = (t || "").match(A) || [""]).length; l--;)
                    if (d = m = (a = Y.exec(t[l]) || [])[1], g = (a[2] || "").split(".").sort(), d) {
                        for (f = h.event.special[d] || {}, p = u[d = (r ? f.delegateType : f.bindType) || d] || [], a = a[2] && new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = p.length; o--;)
        ...
        trigger: function(t, n, r, i) {
            ...
            if (s = a = r = r || p, 3 !== r.nodeType && 8 !== r.nodeType && !V.test(m + h.event.triggered) && (m.indexOf(".") >= 0 && (v = m.split("."), m = v.shift(), v.sort()), c = m.indexOf(":") < 0 && "on" + m, (t = t[h.expando] ? t : new h.Event(m, "object" == typeof t && t)).isTrigger = i ? 2 : 3, t.namespace = v.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + v.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : h.makeArray(n, [t]), d = h.event.special[m] || {}, i || !d.trigger || !1 !== d.trigger.apply(r, n))) {
                if (!i && !d.noBubble && !h.isWindow(r)) {
                    for (u = d.delegateType || m, V.test(u + m) || (s = s.parentNode); s; s = s.parentNode)
                        g.push(s), a = s;
                    a === (r.ownerDocument || p) && g.push(a.defaultView || a.parentWindow || e)
                }
                for (o = 0; (s = g[o++]) && !t.isPropagationStopped();)
                    t.type = o > 1 ? u : d.bindType || m, (f = (F.get(s, "events") || {})[t.type] && F.get(s, "handle")) && f.apply(s, n), (f = c && s[c]) && f.apply && h.acceptData(s) && (t.result = f.apply(s, n), !1 === t.result && t.preventDefault());
            ...
            if (u[0] = e, e.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, e)) {
                for (a = h.event.handlers.call(this, e, l), t = 0; (o = a[t++]) && !e.isPropagationStopped();)
                    for (e.currentTarget = o.elem, n = 0; (s = o.handlers[n++]) && !e.isImmediatePropagationStopped();)
                        (!e.namespace_re || e.namespace_re.test(s.namespace)) && (e.handleObj = s, e.data = s.data, void 0 !== (i = ((h.event.special[s.origType] || {}).handle || s.handler).apply(o.elem, u)) && !1 === (e.result = i) && (e.preventDefault(), e.stopPropagation()));
            ...
            if (a && u.nodeType && (!e.button || "click" !== e.type))
                for (; u !== this; u = u.parentNode || this)
                    if (!0 !== u.disabled || "click" !== e.type) {
                        for (r = [], n = 0; a > n; n++)
                            void 0 === r[i = (o = t[n]).selector + " "] && (r[i] = o.needsContext ? h(i, this).index(u) >= 0 : h.find(i, this, null, [u]).length), r[i] && r.push(o);
                        r.length && s.push({
                            elem: u,
                            handlers: r
                        })
        ...
        fix: function(e) {
            ...
            var t,
                ...
                o = e,
                s = this.fixHooks[i];
            for (s || (this.fixHooks[i] = s = U.test(i) ? this.mouseHooks : z.test(i) ? this.keyHooks : {}), r = s.props ? this.props.concat(s.props) : this.props, e = new h.Event(o), t = r.length; t--;)
                e[n = r[t]] = o[n];
    ...
    se.optgroup = se.option, se.tbody = se.tfoot = se.colgroup = se.caption = se.thead, se.th = se.td, h.extend({
        clone: function(e, t, n) {
            ...
            if (t)
                if (n)
                    for (o = o || pe(e), s = s || pe(a), r = 0, i = o.length; i > r; r++)
                        fe(o[r], s[r]);
                else
                    fe(e, a);
        ...
        buildFragment: function(e, t, n, r) {
            for (var i, o, s, a, u, l, c = t.createDocumentFragment(), f = [], p = 0, d = e.length; d > p; p++)
                if ((i = e[p]) || 0 === i)
                    if ("object" === h.type(i))
                        h.merge(f, i.nodeType ? [i] : i);
                    else if (ee.test(i)) {
                        for (o = o || c.appendChild(t.createElement("div")), s = (Z.exec(i) || ["", ""])[1].toLowerCase(), a = se[s] || se._default, o.innerHTML = a[1] + i.replace(K, "<$1></$2>") + a[2], l = a[0]; l--;)
                            o = o.lastChild;
        ...
        remove: function(e, t) {
            for (var n, r = e ? h.filter(e, this) : this, i = 0; null != (n = r[i]); i++)
                t || 1 !== n.nodeType || h.cleanData(pe(n)), n.parentNode && (t && h.contains(n.ownerDocument, n) && ce(pe(n, "script")), n.parentNode.removeChild(n));
            return this
        },
        empty: function() {
        ...
        domManip: function(e, t) {
            ...
            var n,
                ...
                g = e[0],
                m = h.isFunction(g);
            if (m || c > 1 && "string" == typeof g && !f.checkClone && ne.test(g))
            ...
            if (c && (r = (n = h.buildFragment(e, this[0].ownerDocument, !1, this)).firstChild, 1 === n.childNodes.length && (n = r), r)) {
                for (s = (o = h.map(pe(n, "script"), ue)).length; c > l; l++)
                    a = n, l !== d && (a = h.clone(a, !0, !0), s && h.merge(o, pe(a, "script"))), t.call(this[l], a, l);
                if (s)
                    for (u = o[o.length - 1].ownerDocument, h.map(o, le), l = 0; s > l; l++)
                        a = o[l], re.test(a.type || "") && !F.access(a, "globalEval") && h.contains(u, a) && (a.src ? h._evalUrl && h._evalUrl(a.src) : h.globalEval(a.textContent.replace(oe, "")))
            }
            return this
        }
    }), h.each({
        ...
        h.fn[e] = function(e) {
            for (var n, r = [], i = h(e), s = i.length - 1, a = 0; s >= a; a++)
                n = a === s ? this : this.clone(!0), h(i[a])[t](n), o.apply(r, n.get());
    ...
    function Le(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > o; o += 2)
            "margin" === n && (s += h.css(e, n + B[o], !0, i)), r ? ("content" === n && (s -= h.css(e, "padding" + B[o], !0, i)), "margin" !== n && (s -= h.css(e, "border" + B[o] + "Width", !0, i))) : (s += h.css(e, "padding" + B[o], !0, i), "padding" !== n && (s += h.css(e, "border" + B[o] + "Width", !0, i)));
        return s
    }
    function qe(e, t, n) {
        var r = !0,
        ...
        if (0 >= i || null == i) {
            if ((0 > (i = we(e, t, o)) || null == i) && (i = e.style[t]), xe.test(i))
                return i;
    ...
    function He(e, t) {
        for (var n, r, i, o = [], s = 0, a = e.length; a > s; s++)
            (r = e[s]).style && (o[s] = F.get(r, "olddisplay"), n = r.style.display, t ? (o[s] || "none" !== n || (r.style.display = ""), "" === r.style.display && I(r) && (o[s] = F.access(r, "olddisplay", ve(r.nodeName)))) : o[s] || (i = I(r), (n && "none" !== n || !i) && F.set(r, "olddisplay", i ? n : h.css(r, "display"))));
        for (s = 0; a > s; s++)
        ...
        $e = [function(e, t, n) {
            ...
            if (!h.isEmptyObject(f))
                for (r in g ? "hidden" in g && (d = g.hidden) : g = F.access(e, "fxshow", {}), o && (g.hidden = !d), d ? h(e).show() : c.done(function() {
                    ...
                    s = Xe(d ? g[r] : 0, r, c), r in g || (g[r] = s.start, d && (s.end = s.start, s.start = "width" === r || "height" === r ? 1 : 0))
        }],
        Be = {
            "*": [function(e, t) {
    ...
    function ze(e, t, n) {
        var r,
            ...
            u = function() {
                if (i)
                    return !1;
                for (var t = Fe || Ie(), n = Math.max(0, l.startTime + l.duration - t), r = 1 - (n / l.duration || 0), o = 0, s = l.tweens.length; s > o; o++)
                    l.tweens[o].run(r);
        ...
        finish: function(e) {
            return !1 !== e && (e = e || "fx"), this.each(function() {
                var t,
                    ...
                    o = h.timers,
                    s = r ? r.length : 0;
                for (n.finish = !0, h.queue(this, e, []), i && i.stop && i.stop.call(this, !0), t = o.length; t--;)
    ...
    h.fn.extend({
        ...
        attr: function(e, t, n) {
            var r,
                ...
                o = e.nodeType;
            if (e && 3 !== o && 8 !== o && 2 !== o)
                return typeof e.getAttribute === X ? h.prop(e, t, n) : (1 === o && h.isXMLDoc(e) || (t = t.toLowerCase(), r = h.attrHooks[t] || (h.expr.match.bool.test(t) ? Ue : void 0)), void 0 === n ? r && "get" in r && null !== (i = r.get(e, t)) ? i : null == (i = h.find.attr(e, t)) ? void 0 : i : null !== n ? r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : void h.removeAttr(e, t))
        },
        removeAttr: function(e, t) {
            ...
            if (o && 1 === e.nodeType)
                for (; n = o[i++];)
                    r = h.propFix[n] || n, h.expr.match.bool.test(n) && (e[r] = !1), e.removeAttribute(n)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
    ...
    h.fn.extend({
        ...
        prop: function(e, t, n) {
            var r,
                ...
                o = e.nodeType;
            if (e && 3 !== o && 8 !== o && 2 !== o)
                return (1 !== o || !h.isXMLDoc(e)) && (t = h.propFix[t] || t, i = h.propHooks[t]), void 0 !== n ? i && "set" in i && void 0 !== (r = i.set(e, n, t)) ? r : e[t] = n : i && "get" in i && null !== (r = i.get(e, t)) ? r : e[t]
        },
        propHooks: {
            tabIndex: {
                get: function(e) {
    ...
    h.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(h.isFunction(e) ? function(n) {
                ...
                if ("string" === n)
                    for (var t, r = 0, i = h(this), o = e.match(A) || []; t = o[r++];)
                        i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
                else
                    (n === X || "boolean" === n) && (this.className && F.set(this, "__className__", this.className), this.className = this.className || !1 === e ? "" : F.get(this, "__className__") || "")
            })
        },
        hasClass: function(e) {
            for (var t = " " + e + " ", n = 0, r = this.length; r > n; n++)
                if (1 === this[n].nodeType && (" " + this[n].className + " ").replace(Ge, " ").indexOf(t) >= 0)
                    return !0;
            return !1
        }
    });
    ...
    h.fn.extend({
        ...
        valHooks: {
            select: {
                ...
                set: function(e, t) {
                    for (var n, r, i = e.options, o = h.makeArray(t), s = i.length; s--;)
                        ((r = i[s]).selected = h.inArray(h(r).val(), o) >= 0) && (n = !0);
    ...
    h.param = function(e, t) {
        ...
        if (void 0 === t && (t = h.ajaxSettings && h.ajaxSettings.traditional), h.isArray(e) || e.jquery && !h.isPlainObject(e))
            h.each(e, function() {
    ...
    h.ajaxSetup({
        ...
        var i,
            o,
            s,
            a = !1 !== t.jsonp && (Nt.test(t.url) ? "url" : "string" == typeof t.data && !(t.contentType || "").indexOf("application/x-www-form-urlencoded") && Nt.test(t.data) && "data");
    ...
    h.offset = {
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var e = this.offsetParent || Et; e && !h.nodeName(e, "html") && "static" === h.css(e, "position");)
                    e = e.offsetParent;
                return e || Et
            })
        }
